...
public class PicturesView extends AbstractView {
    ...
    private static PictiuresViewUiBinder uiBinder = GWT
            .create(PictiuresViewUiBinder.class);
    @UiField
    PicturesTopPanel topPanel;
    @UiField
    VerticalPanel optionsPanel;
    @UiField
    JoyPad joyPad;
    @UiField
    MobileButton btnStart;
    @UiField
    MobileButton btnPause;
    @UiField
    MobileButton btnZoomIn;
    @UiField
    MobileButton btnZoomOut;
    @UiField
    MobileButton btnRotateLeft;
    @UiField
    MobileButton btnRotateRight;
    @UiField
    ...
    public PicturesView() {
        ...
        mButtons.addAll(Arrays.asList(new IsCommandableClickHandler[] {
                btnStart, btnPause, btnRotateLeft, btnRotateRight, btnZoomIn,
                btnZoomOut }));
