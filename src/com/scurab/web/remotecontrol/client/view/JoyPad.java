...
public class JoyPad extends AbstractView {
    ...
    InlineLabel btnUp;
    @UiField
    InlineLabel btnRight;
    @UiField
    InlineLabel btnDown;
    @UiField
    InlineLabel btnCenter;
    ...
    public JoyPad() {
        ...
        btnL = CommandableClickHandlerWrapper.asCommandableClickObject(btnLeft,
                COMMAND_LEFT);
        btnR = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnRight, COMMAND_RIGHT);
        btnU = CommandableClickHandlerWrapper.asCommandableClickObject(btnUp,
                COMMAND_UP);
        btnD = CommandableClickHandlerWrapper.asCommandableClickObject(btnDown,
                COMMAND_DOWN);
        btnC = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnCenter, COMMAND_CENTER);

        mList = new ArrayList<IsCommandableClickHandler>();
        mList.addAll(Arrays.asList(new IsCommandableClickHandler[] { btnL,
                btnU, btnR, btnD, btnC }));
    }
