...
public class VideoPlayerView extends AbstractView
{
	...
	@UiField PlayerPad playerPad;
	@UiField JoyPad joyPad;
	@UiField VerticalPanel videoPanel;
	@UiField VerticalPanel audioPanel;
	@UiField VerticalPanel dvdPanel;
	@UiField VerticalPanel subtitlesPanel;
	@UiField VerticalPanel userPanel;
	@UiField VideoPlayerTopPanel topPanel;
	
	@UiField MobileButton btnFullScreen;
	@UiField MobileButton btnRatio;
	@UiField MobileButton btnSaveScreen;
	@UiField MobileButton btnWindowBigger;
	@UiField MobileButton btnWindowSmaller;
	@UiField MobileButton btnVideoSpeedDown;
	@UiField MobileButton btnVideoSpeedReset;
	@UiField MobileButton btnVideoSpeedUp;
	@UiField MobileButton btnAudioDelayUp;
	@UiField MobileButton btnAudioDelayDown;
	@UiField MobileButton btnTrack;
	@UiField MobileButton btnOutput;
	@UiField MobileButton btnSubDelayUp;
	@UiField MobileButton btnSubDelayDown;
	@UiField MobileButton btnSubUp;
	@UiField MobileButton btnSubChange;
	@UiField MobileButton btnSubDown;
	@UiField MobileButton btnShowDVDMenu;
	...
	public VideoPlayerView()
	{
		...
		mButtons.addAll(Arrays.asList(
				new IsCommandableClickHandler[] { btnFullScreen, btnRatio,
				btnSaveScreen, btnWindowBigger, btnWindowSmaller, btnVideoSpeedDown, 
				btnVideoSpeedReset, btnVideoSpeedUp, btnAudioDelayUp, btnAudioDelayDown, 
				btnTrack, btnOutput, btnSubDelayUp, btnSubDelayDown, btnSubUp,
