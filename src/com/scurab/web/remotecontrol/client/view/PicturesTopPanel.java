...
public class PicturesTopPanel extends AbstractView {
    ...
    private static PicturesTopPanelUiBinder uiBinder = GWT
            .create(PicturesTopPanelUiBinder.class);
    @UiField
    ...
    interface PicturesTopPanelUiBinder extends
            UiBinder<Widget, PicturesTopPanel> {
    }
