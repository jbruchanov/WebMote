...
public class ShutdownView extends AbstractView {
    ...
    private static ShutdownViewUiBinder uiBinder = GWT
            .create(ShutdownViewUiBinder.class);
    @UiField
    Label lblOperationStartTime;
    @UiField
    CheckBox chkForce;
    @UiField
    TimePickerWidget timePicker;
    @UiField
    CommandButton btnReboot;
    @UiField
    CommandButton btnShutdown;
    @UiField
    CommandButton btnHibernate;
    @UiField
    CommandButton btnAbort;
    ...
    public ShutdownView() {
        ...
        mList.addAll(Arrays.asList(new IsCommandableClickHandler[] { btnReboot,
                btnShutdown, btnHibernate, btnAbort }));
    }
