...
public class DiskBrowserItem extends Composite implements HasClickHandlers {
    ...
    private static DiskBrowserItemUiBinder uiBinder = GWT
            .create(DiskBrowserItemUiBinder.class);

    @UiField
    ImageMobileButton btnContext;
    @UiField
    Button btnItem;
    ...
    public enum Type {
        Return(-1), Folder(10), File(20), Disk(0), OpticalDevice(2), UsbDevice(
                3), Network(4), Ram(5);
        private int code;
