...
public class AudioPlayerTopPanel extends AbstractView {
    ...
    private static AudioPlayerTopPanelUiBinder uiBinder = GWT
            .create(AudioPlayerTopPanelUiBinder.class);
    @UiField
    ImageMobileButton btnDefault;
    @UiField
    ImageMobileButton btnOptions;
    @UiField
    ...
    interface AudioPlayerTopPanelUiBinder extends
            UiBinder<Widget, AudioPlayerTopPanel> {
    }
