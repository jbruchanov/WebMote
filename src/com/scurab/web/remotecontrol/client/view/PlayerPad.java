...
public class PlayerPad extends AbstractView {
    ...
    private static PlayerPadUiBinder uiBinder = GWT
            .create(PlayerPadUiBinder.class);
    @UiField
    InlineLabel btnMinus;
    @UiField
    InlineLabel btnPlus;
    @UiField
    InlineLabel btnMute;
    ...
    InlineLabel btnStop;
    @UiField
    InlineLabel btnPause;
    @UiField
    InlineLabel btnPlay;
    @UiField
    InlineLabel btnSeekBack;
    @UiField
    InlineLabel btnPrevious;
    @UiField
    InlineLabel btnSeekForward;
    @UiField
    InlineLabel btnNext;
    ...
    public PlayerPad() {
        ...
        cmdMinus = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnMinus, COMMAND_VOLUME_DOWN);
        cmdPlus = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnPlus, COMMAND_VOLUME_UP);
        cmdMute = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnMute, COMMAND_VOLUME_MUTE);

        cmdStop = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnStop, COMMAND_STOP);
        cmdPause = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnPause, COMMAND_PAUSE);
        cmdPlay = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnPlay, COMMAND_PLAY);

        cmdSeekBack = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnSeekBack, COMMAND_SEEK_BCK);
        cmdPrev = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnPrevious, COMMAND_PREVIOUS);
        cmdSeekFwd = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnSeekForward, COMMAND_SEEK_FWD);
        cmdNext = CommandableClickHandlerWrapper.asCommandableClickObject(
                btnNext, COMMAND_NEXT);

        mList = new ArrayList<IsCommandableClickHandler>();
        mList.addAll(Arrays.asList(new IsCommandableClickHandler[] { cmdMinus,
                cmdPlus, cmdMute, cmdStop, cmdPause, cmdPlay, cmdSeekBack,
                cmdPrev, cmdSeekFwd, cmdNext }));
    }
