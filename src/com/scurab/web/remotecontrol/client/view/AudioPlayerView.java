...
public class AudioPlayerView extends AbstractView
{
	...
	@UiField AudioPlayerTopPanel topPanel;
	@UiField PlayerPad playerPad;
	@UiField VerticalPanel layoutPanel;
	@UiField VerticalPanel userPanel;
	@UiField MobileButton btnRepeat;
	@UiField MobileButton btnShuffle;
	@UiField MobileButton btnCollapse;
	@UiField MobileButton btnHide;
	...
	public AudioPlayerView()
	{
		...
		mButtons.addAll(Arrays.asList(
				new IsCommandableClickHandler[] { btnRepeat,btnShuffle,btnCollapse,btnHide}));
