...
public class ConfigView extends AbstractView {
    ...
    private static ConfigViewUiBinder uiBinder = GWT
            .create(ConfigViewUiBinder.class);
    @UiField
    TextBox txtPIN;
    @UiField
    ListBox cmbTV;
    @UiField
    ListBox cmbVideoPlayer;
    @UiField
    ListBox cmbAudioPlayer;
    @UiField
    ListBox cmbPictureViewer;
    @UiField
    ListBox cmbMediaCenter;
    @UiField
    ListBox cmbIRDevices;
    @UiField
    Button btnSave;
    @UiField
    Button btnFavorites;
