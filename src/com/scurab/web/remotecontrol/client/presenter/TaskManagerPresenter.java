...
public class TaskManagerPresenter extends BaseControlPresenter {
    ...
    public TaskManagerPresenter(DataService dataService,
            HandlerManager eventBus, TaskManagerView display) {
        ...
        try {
            ...
            mDataService.sendCommand(pc, new RequestCallback() {
                ...
                public void onResponseReceived(Request request,
                        Response response) {
                    List<HashMap<String, String>> data = JsonSimpleParser
    ...
    public void onProcessItemClick(Proc p) {
        TaskManagerContextMenu.showDialog(p,
                new TaskManagerContextMenu.OnClickListener() {
                    @Override
