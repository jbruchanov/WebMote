...
public class ConfigPresenter extends BaseControlPresenter {
    ...
    public ConfigPresenter(DataService dataService, HandlerManager eventBus,
            ConfigView display) {
    ...
    protected void load() {
        onSendCommand(new InfoCommand(), new RequestCallback() {
            ...
            public void onResponseReceived(Request request, Response response) {
                try {
                    InfoCommand ic = JsonSimpleParser.parseInfoCommand(response
                            .getText());
                    RemoteControl.setProperty(
                            RemoteControl.PropertyKeys.PATH_SEPARATOR,
                            ic.getPathSeparator());
    ...
    protected void onLoadedData(HashMap<String, List<String>> data)
            throws Exception {
        for (String key : data.keySet()) {
            initValues(key, data.get(key));
        }

        if (!data.containsKey(RemoteControl.PropertyKeys.IRDEVICE)) {
        ...
        mDisplay.getBtnFavorites().addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                mEventBus.fireEvent(new ChangePresenterEvent(
                        new FavoritiesPresenter(mDataService, mEventBus,
                                new FavoritiesView())));
            }
        });

        mDisplay.getBtnFavorites()
                .setEnabled(Storage.isLocalStorageSupported());
        ...
        public void sendCommand(Command c, RequestCallback rc)
            ...
            Response r = new Response() {
                ...
                public String getText() {
                    // return
                    // "{\"Audio\":[\"WinAmp\"],\"MediaCenter\":[],\"Picture\":[\"Media Center Pictures\",\"Windows Photo Viewer\"],\"Television\":[\"Avermedia TV\"],\"Video\":[\"Media Player classic\",\"VLC Player\"],\"WinLIRC\":[\"logitech_z680\",\"Panasonic_EUR644340\"]}";
                    // return
                    // "{\"Audio\":[\"WinAmp\"],\"MediaCenter\":[],\"Picture\":[\"Media Center Pictures\",\"Windows Photo Viewer\"],\"Television\":[\"Avermedia TV\"],\"Video\":[\"Media Player classic\",\"VLC Player\"]}";
                    return "{\"ComputerName\":\"ELEPHANT-W8\",\"Applications\":{\"MediaCenter\":[\"Media Center\",\"XBMC\",\"Media Portal\"],\"Audio\":[\"Media Center Audio\",\"WinAmp\",\"XBMC Audio\",\"Media Portal Audio\",\"Windows Media Player Audio\"],\"InfraRed\":[\"logitech_z680\",\"Panasonic_EUR644340\"],\"Video\":[\"VLC PLayer\",\"Media Center Video\",\"Media Portal Video\",\"Media Player classic\",\"Windows Media Player Video\",\"XBMC Video\"],\"Television\":[\"Media Portal TV\",\"Media Center TV\",\"Avermedia TV\"],\"Picture\":[\"Windows Photo Viewer\",\"Media Portal Pictures\",\"Media Center Pictures\",\"XBMC Pictures\",\"IrfanView\",\"Picasa\"]},\"MACs\":[\"DC:A9:71:1A:0A:C2\",\"DC:A9:71:1A:0A:C3\",\"00:15:5D:C1:F8:F9\",\"08:00:27:00:F0:B2\",\"DC:A9:71:1A:0A:C6\"],\"Command\":\"InfoCommand\",\"ProtocolVersion\":0}";
                }
