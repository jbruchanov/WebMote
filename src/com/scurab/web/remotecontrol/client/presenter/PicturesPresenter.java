...
public class PicturesPresenter extends BaseControlPresenter {
    ...
    public PicturesPresenter(DataService dataService, HandlerManager eventBus,
            PicturesView display) {
    ...
    private void bind() {
        ...
        mDisplay.getTopPanel().getBtnOptions()
                .addClickHandler(new ClickHandler() {
                    @Override
                    public void onClick(ClickEvent event) {
    ...
    protected void onClickButton(ShowPanel what) {
        ...
        switch (what) {
            case Default:
                ...
                break;
            case Options:
                mCurrentVisibleWidget = mDisplay.getOptionsPanel();
                break;
            case User:
    ...
    protected Command getCommand(String command) {
        ApplicationCommand pvc = new ApplicationCommand(mAppName,
                AppType.Picture);
