...
public class RemoteControl implements EntryPoint {
    ...
    public static void addToFavorites(String category, String key,
            String location) {
    ...
    public static class PropertyKeys {
        ...
        public static final String[] ALL_APP_PROPERTY_KEYS = new String[] {
                RemoteControl.PropertyKeys.AUDIOPLAYER,
                RemoteControl.PropertyKeys.MEDIACENTER,
                RemoteControl.PropertyKeys.PICTURESVIEWER,
                RemoteControl.PropertyKeys.TVAPPLIATION,
                RemoteControl.PropertyKeys.VIDEOPLAYER,
                RemoteControl.PropertyKeys.IRDEVICE };
    }
}
