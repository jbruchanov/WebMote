...
public class FileBrowserContextMenu extends DialogBox {
    ...
    public enum ContextType {
        AudioPlayer, PicturesViewer, VideoPlayer, StartByOS, AddToFavorites, Cancel, Open, Close
    }

    private FileBrowserContextMenu(DiskBrowserItem item,
            OnClickListener listener, boolean favs) {
        setTitle("Open in...");
        setModal(true);
    ...
    private Widget buildFolderWidget(final DiskBrowserItem item,
    ...
    private Widget buildFavsWidget(final DiskBrowserItem item,
            final OnClickListener listener) {
        FlowPanel fp = new FlowPanel();
        fp.add(new Label(item.getValue()));
        fp.add(getButton(item, listener, ContextType.AudioPlayer));
    ...
    private MobileButton getButton(final DiskBrowserItem item,
            final OnClickListener listener, final ContextType type) {
